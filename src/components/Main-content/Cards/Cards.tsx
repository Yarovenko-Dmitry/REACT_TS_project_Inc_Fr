...
const Cards = () => {
	...
	const tableCell = [{name: 'Question', align: 'inherit'}, {name: 'Answer', align: 'center'}, {
		name: 'Grade', align: 'center'
	}, {name: 'Delete', align: 'center'}, {name: 'Modify', align: 'left'}, {name: 'Updated', align: 'right'},];
		...
		return (<div>
				<TableContainer component={Paper}>
					...
					<TableData heading={tableCell}>
						{cards.map((row: CardType) => (<TableRow key={row._id}>
				...
				<ModalWindow handleClose={() => handleDialogClose()} isOpen={isOpen} title={'Add' + ' new card'}>
